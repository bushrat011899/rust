...
pub use alloc_crate::io::{
    BufRead, BufReader, BufWriter, Bytes, Chain, IntoInnerError, LineWriter, Lines, Read, Seek,
    SeekFrom, Split, Take, Write, read_to_string,
};
#[unstable(feature = "core_io_internals", reason = "exposed only for libstd", issue = "none")]
pub use alloc_crate::io::{
    DEFAULT_BUF_SIZE, IoHandle, SizeHint, SpecReadByte, append_to_string, default_read_buf,
    default_read_buf_exact, default_read_exact, default_read_to_end, default_read_to_string,
    default_read_vectored, default_write_vectored, read_until, skip_until, stream_len_default,
};
